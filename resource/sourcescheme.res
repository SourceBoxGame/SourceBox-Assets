...
Scheme
{
	...
	Colors
	{
		...
		"Orange"			"247 154 16 255"
		"DarkOrange"		"137 84 8 255"
	...
	BaseSettings
	{
		...
		Border.Dark						"247 154 16 255"		// the dark/unlit side of a control
		...
		FrameGrip.Color1				"Orange"
		FrameGrip.Color2				"Orange"
		...
		Label.BgColor					"Blank"
		Label.DisabledFgColor1			"DarkOrange"
		...
		Knob.BgColor			"TransparentBlack"
		Knob.DarkColor  			"Border.Dark" 		// the left checkbutton border
		Knob.LightColor  			"Border.Bright"		// the right checkbutton border
		Knob.NotchColor			"White"	// color of the check itself
